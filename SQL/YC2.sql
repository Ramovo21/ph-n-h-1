...
-- ===================== GROUPS (Co so) =====================
EXEC LBACSYS.SA_COMPONENTS.CREATE_GROUP('BV_POLICY', 10, 'CSALL', 'Tat Ca Co So', NULL);
EXEC LBACSYS.SA_COMPONENTS.CREATE_GROUP('BV_POLICY', 11, 'HCM',   'Ho Chi Minh',  'CSALL');
EXEC LBACSYS.SA_COMPONENTS.CREATE_GROUP('BV_POLICY', 12, 'HP',    'Hai Phong',    'CSALL');
EXEC LBACSYS.SA_COMPONENTS.CREATE_GROUP('BV_POLICY', 13, 'HN',    'Ha Noi',       'CSALL');

-- ===================== TAO LABELS =====================
EXEC LBACSYS.SA_LABEL_ADMIN.CREATE_LABEL('BV_POLICY', 30000, 'BGD::CSALL', TRUE);
EXEC LBACSYS.SA_LABEL_ADMIN.CREATE_LABEL('BV_POLICY', 20000, 'LDK::CSALL', TRUE);
EXEC LBACSYS.SA_LABEL_ADMIN.CREATE_LABEL('BV_POLICY', 20100, 'LDK:TH:CSALL', TRUE);
...
EXEC LBACSYS.SA_LABEL_ADMIN.CREATE_LABEL('BV_POLICY', 10001, 'NV',  TRUE);
EXEC LBACSYS.SA_LABEL_ADMIN.CREATE_LABEL('BV_POLICY', 20001, 'LDK', TRUE);

-- ===================== GAN LABEL CHO ADMIN =====================
EXEC LBACSYS.SA_USER_ADMIN.SET_USER_LABELS('BV_POLICY','BV_ADMIN','BGD:TH,TK,TM:CSALL','BGD:TH,TK,TM:CSALL','NV','BGD:TH,TK,TM:CSALL','BGD::CSALL');
...
UPDATE BVOWNER.THONGBAO SET OLS_LABEL = 30000 WHERE MATB = 'TB_001';
UPDATE BVOWNER.THONGBAO SET OLS_LABEL = 10001 WHERE MATB = 'TB_002';
UPDATE BVOWNER.THONGBAO SET OLS_LABEL = 20001 WHERE MATB = 'TB_003';
