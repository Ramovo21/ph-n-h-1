...
GRANT READ, WRITE ON DIRECTORY BACKUP_DIR TO BVOWNER;
...
BEGIN
   ...
   VALUES (v_ts, 'AUTO_EXPORT', 'STARTED');
   COMMIT;
...
BEGIN
   DBMS_SCHEDULER.DROP_JOB('BV_ADMIN.JOB_DAILY_BACKUP', TRUE);
...
BEGIN
    DBMS_SCHEDULER.CREATE_JOB(
        job_name        => 'BV_ADMIN.JOB_DAILY_BACKUP',
