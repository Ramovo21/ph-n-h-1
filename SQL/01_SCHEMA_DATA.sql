...
CREATE TABLE NHANVIEN (
    ...
    -- Tên đăng nhập Oracle (kết nối TC#1 với Oracle account)
...
INSERT INTO THONGBAO VALUES ('TB_001',N'Hop khan ban giam doc: Chien luoc 2026',SYSTIMESTAMP,N'Phong hop BGD - Co so HCM');
INSERT INTO THONGBAO VALUES ('TB_002',N'Cuoc hop toan bo nhan vien benh vien',SYSTIMESTAMP,N'Hoi truong A');
